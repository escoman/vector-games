...
void draw_diag_screen(void)
{
    ...
    /* --- Заголовок --- */
    gfx_print(24, 0, "MUSIC DIAGNOSTIC", 8);

    /* --- IRQ / MUSIC --- */
    ulong_to_str(diag_irq_count, num);
    gfx_print(24, 16, "IRQ:", 8);
    gfx_print(80, 16, num, 8);

    ulong_to_str(diag_music_tick_count, num);
    gfx_print(24, 24, "MUSIC:", 8);
    gfx_print(80, 24, num, 8);

    ulong_to_str(diag_music_time, num);
    gfx_print(152, 24, "TIME:", 8);
    gfx_print(200, 24, num, 8);

    /* --- SCORE0 --- */
    gfx_print(0, 40, "SCORE0", 8);

    ulong_to_str(diag_score0_steps, num);
    gfx_print(8, 48, "STEPS:", 8);
    gfx_print(80, 48, num, 8);

    ulong_to_str(diag_score0_time, num);
    gfx_print(8, 56, "TIME:",  8);
    gfx_print(80, 56, num, 8);

    gfx_print(8, 64, "FINISH:", 8);
    gfx_print(80, 64,
                diag_score0_finished ? "YES" : "NO ", 8);

    ulong_to_str(diag_score0_finish_irq, num);
    gfx_print(8, 72, "F-IRQ:", 8);
    gfx_print(80, 72, num, 8);

    ulong_to_str(diag_score0_finish_time, num);
    gfx_print(8, 80, "F-TIME:", 8);
    gfx_print(80, 80, num, 8);

    /* --- DRUMS --- */
    gfx_print(0, 96, "DRUMS", 8);

    ulong_to_str(diag_drums_steps, num);
    gfx_print(8, 104, "STEPS:", 8);
    gfx_print(80, 104, num, 8);

    ulong_to_str(diag_drums_time, num);
    gfx_print(8, 112, "TIME:",  8);
    gfx_print(80, 112, num, 8);

    gfx_print(8, 120, "FINISH:", 8);
    gfx_print(80, 120,
                diag_drums_finished ? "YES" : "NO ", 8);

    ulong_to_str(diag_drums_finish_irq, num);
    gfx_print(8, 128, "F-IRQ:", 8);
    gfx_print(80, 128, num, 8);

    ulong_to_str(diag_drums_finish_time, num);
    gfx_print(8, 136, "F-TIME:", 8);
    gfx_print(80, 136, num, 8);

    /* --- DIFF (ТЗ §14-15) --- */
    gfx_print(0, 152, "DIFF", 8);

    ulong_to_str(pos_diff, num);
    gfx_print(8, 160, "STEPS:", 8);
    gfx_print(80, 160, num, 8);

    /* time diff */
    if (diag_score0_time > diag_drums_time) {
        ulong_to_str(diag_score0_time - diag_drums_time, num);
        gfx_print(8, 168, "TIME:-", 8);
    } else {
        ulong_to_str(diag_drums_time - diag_score0_time, num);
        gfx_print(8, 168, "TIME: ", 8);
    }
    gfx_print(80, 168, num, 8);

    /* IRQ diff */
    if (diag_score0_finish_irq > diag_drums_finish_irq) {
        ulong_to_str(diag_score0_finish_irq - diag_drums_finish_irq, num);
        gfx_print(8, 176, "IRQ: -", 8);
    } else {
        ulong_to_str(diag_drums_finish_irq - diag_score0_finish_irq, num);
        gfx_print(8, 176, "IRQ:  ", 8);
    }
    gfx_print(80, 176, num, 8);

    /* --- POS DIFF (ТЗ §16-17) --- */
    ulong_to_str(s0_pos, num);
    gfx_print(8, 192, "S0 POS:", 8);
    gfx_print(80, 192, num, 8);

    ulong_to_str(dr_pos, num);
    gfx_print(8, 200, "DR POS:", 8);
    gfx_print(80, 200, num, 8);

    ulong_to_str(pos_diff, num);
    gfx_print(8, 208, "PDIFF:", 8);
    gfx_print(80, 208, num, 8);
}
