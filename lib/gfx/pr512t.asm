...
font_thin:
        ...
        ; '@'
        defb    0x00, 0x66, 0x18, 0x3E, 0x1C, 0x3E, 0x08, 0x66
        ; '<'
        defb    0x00, 0x00, 0x22, 0x66, 0x88, 0x66, 0x22, 0x00
        ; '>'
        defb    0x00, 0x88, 0x44, 0x22, 0x00, 0x22, 0x44, 0x88
        ; '='
        defb    0x00, 0x00, 0xEE, 0x00, 0xEE, 0x00, 0x00, 0x00
        ; '&'
        defb    0x44, 0x48, 0x44, 0x66, 0x99, 0x48, 0x44, 0x00
        ; '$'
        defb    0x44, 0x6E, 0x8C, 0x6E, 0x26, 0xEE, 0x44, 0x00
        ; '#'
        defb    0x66, 0x66, 0xEE, 0x66, 0xEE, 0x66, 0x66, 0x00
        ; '*'
        defb    0x04, 0x46, 0x64, 0xEE, 0x64, 0x46, 0x04, 0x00
        ; '+'
        defb    0x21, 0x21, 0x21, 0xFF, 0x21, 0x21, 0x21, 0x00
        ; '%'
        defb    0x8D, 0x2C, 0x8E, 0x40, 0x27, 0x83, 0x2B, 0x00
