...
Формат Вектора-06Ц (512x256, 2 цвета, расширенная плоскость):
  - экранное ОЗУ 16 КБ: 0xA000-0xBFFF + 0xE000-0xFFFF, по 8 КБ на плоскость:
      0xA000 — плоскость 1 (вес цвета 2, бит 1)
      0xE000 — плоскость 0 (вес цвета 1, бит 0)
  - режим 512x256: порт 02h, бит 4 = 1
  - чётные X (0,2,4,...) → плоскость 0 (E000h), бит 0
  - нечётные X (1,3,5,...) → плоскость 1 (A000h), бит 1
...
def build_plane(width, height, pixels, plane):
    ...
    plane=1 — нечётные X (плоскость 1, A000h),
...
def main():
    ...
    # сначала плоскость 1 (нечётные X, A000h), потом плоскость 0 (чётные X, E000h).
    w16 = (width + 15) // 16
    ...
    # 64 блока: 32 для плоскости 1 (A000h) + 32 для плоскости 0 (E000h)
    ...
    with open(inc_path, "w") as f:
        ...
        f.write(f"/* Обе плоскости: plane 1 (A000h) + plane 0 (E000h) */\n\n")
