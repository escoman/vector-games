...
/* Установить тон канала ch (0=A/1=B/2=C): div_VI53 — делитель из
 * таблицы нот ВИ53, конвертируется в период AY (887/12000, 1..4095);
 * 0 = тишина (громкость в 0). Применяет огибающую на атаке, если для
 * канала выставлен ay_env_mode (см. ay_set_envelope). */
